...
namespace SleepyDiscord {
	...
	Server::Server(const std::string_view & json) :
		Server(json::fromJSON<Server>(json)) {
	}
	...
	UnavailableServer::UnavailableServer(const std::string_view & json) :
		UnavailableServer(json::fromJSON<UnavailableServer>(json)) {
	}
	...
	ServerEmbed::ServerEmbed(const std::string_view & json) :
		ServerEmbed(json::fromJSON<ServerEmbed>(json)) {
	}
}
